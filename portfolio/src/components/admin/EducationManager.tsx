...
const EducationManager: React.FC = () => {
  ...
  const resetForm = () => {
    setForm({ school: '', degree: '', field: '', startDate: '', endDate: '', description_fr: '', description_en: '' });
    setEditing(null);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-1">Description (FR)</label>
            <textarea
              ...
              rows={2}
            />
            <label className="block text-sm font-medium text-gray-900 mb-1 mt-2">Description (EN)</label>
            <textarea
                ...
                <div key={edu._id} className="border rounded-lg p-4 hover:bg-gray-50">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      {edu.description_fr && (
                        <p className="text-sm text-gray-700 mt-2">FR : {edu.description_fr}</p>
                      )}
                      {edu.description_en && (
                        <p className="text-sm text-gray-700 mt-2">EN : {edu.description_en}</p>
                      )}
                    </div>
